...
const PromoCard = (props) => {
  return (
    ...
    <div className="card-body d-flex flex-column gap-2">
      <h5 className="card-title text-uppercase fw-bold">Titulo</h5>
      <div className="m-0 row h-100 align-items-center justify-content-center">
        ...
        <div className="col h-100 card-text bg-dark">
          ...
          <p className="carValor m-0 p-0 fs-4 text-end fw-bolder">
            R$99,99
          </p>
        </div>
      </div>
      <button id='addCarrinho' className="btn desconto text-light w-100 border-0">
